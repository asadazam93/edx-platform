...
class InlineDiscussionTest(UniqueCourseTest, DiscussionResponsePaginationTestMixin):
    ...
    def check_anonymous_to_peers(self, is_staff):
        ...
        thread_fixture.push()
        self.discussion_page.expand_discussion()
        self.discussion_page.show_thread(thread.get("id"))
        self.assertEqual(self.discussion_page.thread_page.is_thread_anonymous(), not is_staff)
    ...
    def test_discussion_blackout_period(self):
        ...
        self.discussion_page.expand_discussion()
        self.discussion_page.show_thread(thread.get("id"))
        self.assertFalse(self.discussion_page.thread_page.has_add_response_button())
        self.assertFalse(self.discussion_page.thread_page.is_element_visible("action-more"))
